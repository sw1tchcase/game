...
/*
    ...
    void main()
    {
        float _50 = position.x + float(gl_InstanceID % 8);
        float _56 = position.y + float(gl_InstanceID / 8);
        gl_Position = mat4(terrain_vs_params[0], terrain_vs_params[1], terrain_vs_params[2], terrain_vs_params[3]) * vec4(_50, 0.0, _56, 1.0);
        frag_pos = vec3(_50, 0.0, _56);
        view_pos = terrain_vs_params[4].xyz;
    }

*/
@(private)
terrain_vs_source_glsl430 := [513]u8 {
    ...
    0x20,0x5f,0x35,0x30,0x20,0x3d,0x20,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x2e,
    ...
    0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x35,0x36,0x20,0x3d,0x20,0x70,0x6f,
    ...
    0x33,0x5d,0x29,0x20,0x2a,0x20,0x76,0x65,0x63,0x34,0x28,0x5f,0x35,0x30,0x2c,0x20,
    0x30,0x2e,0x30,0x2c,0x20,0x5f,0x35,0x36,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,
    0x20,0x20,0x20,0x20,0x66,0x72,0x61,0x67,0x5f,0x70,0x6f,0x73,0x20,0x3d,0x20,0x76,
    0x65,0x63,0x33,0x28,0x5f,0x35,0x30,0x2c,0x20,0x30,0x2e,0x30,0x2c,0x20,0x5f,0x35,
    0x36,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x76,0x69,0x65,0x77,0x5f,0x70,0x6f,0x73,
    0x20,0x3d,0x20,0x74,0x65,0x72,0x72,0x61,0x69,0x6e,0x5f,0x76,0x73,0x5f,0x70,0x61,
    0x72,0x61,0x6d,0x73,0x5b,0x34,0x5d,0x2e,0x78,0x79,0x7a,0x3b,0x0a,0x7d,0x0a,0x0a,
    0x00,
}
/*
    #version 430
